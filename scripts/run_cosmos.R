...
write_csv(SIF, file = paste("results/adjusted_run/", "SIF.csv", sep = ""))
write_csv(ATT, file = paste("results/adjusted_run/", "ATT.csv", sep = ""))
...
write_csv(SIF_back, file = paste("results/adjusted_run/",paste("SIF_back.csv",sep = ""), sep = ""))
write_csv(ATT_back, file = paste("results/adjusted_run/",paste("ATT_back.csv",sep = ""), sep = ""))
...
write_csv(SIF_full, file = paste("results/adjusted_run/",paste("SIF_full.csv",sep = ""), sep = ""))
write_csv(ATT_full, file = paste("results/adjusted_run/",paste("ATT_full.csv",sep = ""), sep = ""))
